...
type Cart struct {
	...
	Discounts           []Discount       `json:"discounts"  gorm:"column:discounts;many2many:cart_discounts"`
	GiftCards           []GiftCard       `json:"gift_cards"  gorm:"column:gift_cards;many2many:cart_gift_cards"`
	...
	PaymentSession      *PaymentSession  `json:"payment_session"  gorm:"column:payment_session;foreignKey:Id"`
	PaymentSessions     []PaymentSession `json:"payment_sessions"  gorm:"column:payment_sessions;foreignKey:Id"`
