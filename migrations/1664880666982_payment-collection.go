...
type PaymentCollection1664880666982 struct {
	r Registry
}

func (m *PaymentCollection1664880666982) GetName() string {
	return reflect.Indirect(reflect.ValueOf(m)).Type().Name()
}

func (m *PaymentCollection1664880666982) Up() error {
...
func (m *PaymentCollection1664880666982) Down() error {
	if err := m.r.Context().Exec(`
