...
type DropFksIsolatedProduct1694602553610 struct {
	r Registry
}

func (m *DropFksIsolatedProduct1694602553610) GetName() string {
	return reflect.Indirect(reflect.ValueOf(m)).Type().Name()
}

func (m *DropFksIsolatedProduct1694602553610) Up() error {
...
func (m *DropFksIsolatedProduct1694602553610) Down() error {
	if err := m.r.Context().Exec(`
