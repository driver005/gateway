    ...
    "definitions": {
        ...
        "methods.PaymentIntentPaymentMethodOptionsCard1": {
            ...
            "properties": {
                ...
                "verification_method": {
                    "description": "Installments  *paymentFlow.PaymentFlowsInstallmentOptions ` + "`" + `json:\"installments,omitempty\"  gorm:\"foreignKey:id\" swaggertype:\"primitive,string\" format:\"uuid\"` + "`" + `\nBank account verification method.",
                    "type": "string"
                }
            }
        },
