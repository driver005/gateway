...
func newStore(db *gorm.DB, opts ...gen.DOOption) store {
	...
	_store.DefaultCurrencyCode = field.NewString(tableName, "default_currency_code")
	_store.SwapLinkTemplate = field.NewString(tableName, "swap_link_template")
	_store.CreatedAt = field.NewTime(tableName, "created_at")
	_store.UpdatedAt = field.NewTime(tableName, "updated_at")
	_store.Metadata = field.NewString(tableName, "metadata")
	_store.PaymentLinkTemplate = field.NewString(tableName, "payment_link_template")
	_store.InviteLinkTemplate = field.NewString(tableName, "invite_link_template")
	_store.DefaultSalesChannelID = field.NewString(tableName, "default_sales_channel_id")
	_store.DefaultLocationID = field.NewString(tableName, "default_location_id")
...
type store struct {
	...
	ID                    field.String
	Name                  field.String
	DefaultCurrencyCode   field.String
	SwapLinkTemplate      field.String
	CreatedAt             field.Time
	UpdatedAt             field.Time
	Metadata              field.String
	PaymentLinkTemplate   field.String
	InviteLinkTemplate    field.String
	DefaultSalesChannelID field.String
	DefaultLocationID     field.String
...
func (s *store) updateTableName(table string) *store {
	...
	s.DefaultCurrencyCode = field.NewString(table, "default_currency_code")
	s.SwapLinkTemplate = field.NewString(table, "swap_link_template")
	s.CreatedAt = field.NewTime(table, "created_at")
	s.UpdatedAt = field.NewTime(table, "updated_at")
	s.Metadata = field.NewString(table, "metadata")
	s.PaymentLinkTemplate = field.NewString(table, "payment_link_template")
	s.InviteLinkTemplate = field.NewString(table, "invite_link_template")
	s.DefaultSalesChannelID = field.NewString(table, "default_sales_channel_id")
	s.DefaultLocationID = field.NewString(table, "default_location_id")
...
func (s *store) fillFieldMap() {
	...
	s.fieldMap["default_currency_code"] = s.DefaultCurrencyCode
	s.fieldMap["swap_link_template"] = s.SwapLinkTemplate
	s.fieldMap["created_at"] = s.CreatedAt
	s.fieldMap["updated_at"] = s.UpdatedAt
	s.fieldMap["metadata"] = s.Metadata
	s.fieldMap["payment_link_template"] = s.PaymentLinkTemplate
	s.fieldMap["invite_link_template"] = s.InviteLinkTemplate
	s.fieldMap["default_sales_channel_id"] = s.DefaultSalesChannelID
	s.fieldMap["default_location_id"] = s.DefaultLocationID
}
