...
func newCountry(db *gorm.DB, opts ...gen.DOOption) country {
	...
	_country.ID = field.NewInt32(tableName, "id")
	_country.Iso2 = field.NewString(tableName, "iso_2")
	_country.Iso3 = field.NewString(tableName, "iso_3")
	_country.NumCode = field.NewInt32(tableName, "num_code")
	_country.Name = field.NewString(tableName, "name")
	_country.DisplayName = field.NewString(tableName, "display_name")
	_country.RegionID = field.NewString(tableName, "region_id")
...
func (c *country) updateTableName(table string) *country {
	...
	c.Iso2 = field.NewString(table, "iso_2")
	c.Iso3 = field.NewString(table, "iso_3")
	c.NumCode = field.NewInt32(table, "num_code")
...
func (c country) Columns(cols ...field.Expr) gen.Columns { return c.countryDo.Columns(cols...) }
...
func (c *country) fillFieldMap() {
	...
	c.fieldMap["id"] = c.ID
	c.fieldMap["iso_2"] = c.Iso2
	c.fieldMap["iso_3"] = c.Iso3
	c.fieldMap["num_code"] = c.NumCode
