...
func newNote(db *gorm.DB, opts ...gen.DOOption) note {
	...
	_note.Value = field.NewString(tableName, "value")
	_note.ResourceType = field.NewString(tableName, "resource_type")
	_note.ResourceID = field.NewString(tableName, "resource_id")
	...
	_note.Metadata = field.NewString(tableName, "metadata")
...
func (n *note) updateTableName(table string) *note {
	...
	n.Value = field.NewString(table, "value")
