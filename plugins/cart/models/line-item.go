...
type LineItem struct {
	...
	CartId                string               `gorm:"column:cart_id;type:text;not null;index:IDX_line_item_cart_id,priority:1" json:"cart_id"`
	...
	VariantId             string               `gorm:"column:variant_id;type:text;index:IDX_line_item_variant_id,priority:1" json:"variant_id"`
	ProductId             string               `gorm:"column:product_id;type:text;index:IDX_line_item_product_id,priority:1" json:"product_id"`
