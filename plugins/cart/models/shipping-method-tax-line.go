...
type ShippingMethodTaxLine struct {
	...
	TaxRateId        string          `gorm:"column:tax_rate_id;type:text;index:IDX_shipping_method_tax_line_tax_rate_id,priority:1" json:"tax_rate_id"`
	...
	ShippingMethodId string          `gorm:"column:shipping_method_id;type:text;index:IDX_tax_line_shipping_method_id,priority:1" json:"shipping_method_id"`
...
func (*ShippingMethodTaxLine) TableName() string {
	return "cart_shipping_method_tax_line"
}
