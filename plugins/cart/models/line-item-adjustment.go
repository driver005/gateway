...
type LineItemAdjustment struct {
	...
	PromotionId string    `gorm:"column:promotion_id;type:text;index:IDX_line_item_adjustment_promotion_id,priority:1" json:"promotion_id"`
	...
	ItemId      string    `gorm:"column:item_id;type:text;index:IDX_adjustment_item_id,priority:1" json:"item_id"`
...
func (*LineItemAdjustment) TableName() string {
	return "cart_line_item_adjustment"
}
