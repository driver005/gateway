...
type ShippingMethodAdjustment struct {
	...
	PromotionId      string          `gorm:"column:promotion_id;type:text;index:IDX_shipping_method_adjustment_promotion_id,priority:1" json:"promotion_id"`
	...
	ShippingMethodId string          `gorm:"column:shipping_method_id;type:text;index:IDX_adjustment_shipping_method_id,priority:1" json:"shipping_method_id"`
...
func (*ShippingMethodAdjustment) TableName() string {
	return "cart_shipping_method_adjustment"
}
