...
type Address struct {
	...
	CustomerId        string `gorm:"column:customer_id;type:text;uniqueIndex:IDX_customer_address_unique_customer_billing,priority:1" json:"customer_id"`
	AddressName       string `gorm:"column:address_name;type:text" json:"address_name"`
	IsDefaultShipping bool   `gorm:"column:is_default_shipping;type:boolean;not null" json:"is_default_shipping"`
	IsDefaultBilling  bool   `gorm:"column:is_default_billing;type:boolean;not null" json:"is_default_billing"`
